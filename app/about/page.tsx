    ...
    >
      ...
      <Section heading="Vaatlerimiz">
        <p>
          ...
          tutarlıdır. Bir uygulamanın tıbbi/psikolojik yerine geçemeyeceğini bilirsin — biz de öyle
          davranırız.
        </p>
      </Section>
      ...
      <Section heading="Yapım">
        <p>
          ...
          kanal + merkez hesabı, Pythagorean numeroloji (master sayıları korur) ve Claude API ile
